...
const SynopsisMonth = ({
  // Redux State
  metrics: { totalHitsBlock, totalHitsSynopsisMonth },
}) => {
      ...
      <div>
        {currentValue == 0 ? (
          <div className='value--change--text'>
            ...
            <span style={{ color: "grey" }}>constant</span> since last month
          </div>
        ) : (
...
export default connect(mapStateToProps, mapStateToActions)(SynopsisMonth);
